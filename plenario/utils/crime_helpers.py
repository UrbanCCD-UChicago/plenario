...
from plenario.database import Base, task_engine as engine
from plenario.models import MasterTable, crime_table
from plenario.utils.helpers import download_csv
...
def raw_crime(fpath=None, tablename='raw_chicago_crimes_all'):
    ...
    if not fpath:
        fpath = download_csv(CRIMES, 'crime')
