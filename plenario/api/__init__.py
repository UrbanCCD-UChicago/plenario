...
api.add_url_rule(prefix + '/sensor-networks/<network>/map', 'sensor_network_map', get_network_map)
api.add_url_rule(prefix + '/sensor-networks/<network>/nearest', 'nearest', get_observation_nearest)
api.add_url_rule(prefix + '/sensor-networks/<network>/check', 'check', check)
